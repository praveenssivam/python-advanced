# Day 4 — Functional Programming in Python
...
| `10_combined_functional_patterns.py` | Everything combined | Full lazy pipeline using all Day 4 techniques |
...
python demo/day-04/01_first_class_functions.py
python demo/day-04/02_closures.py
python demo/day-04/03_functools_partial.py
python demo/day-04/04_functools_reduce.py
python demo/day-04/05_functools_lru_cache.py
python demo/day-04/06_function_composition.py
python demo/day-04/07_immutability.py
python demo/day-04/08_generators_vs_lists.py
python demo/day-04/09_functional_vs_oop.py
python demo/day-04/10_combined_functional_patterns.py
```
