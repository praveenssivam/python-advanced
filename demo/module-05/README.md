# Module 5 — Concurrency in Python
...
python demo/module-05/03_threading_io_bound.py
python demo/module-05/04_multiprocessing_cpu_bound.py
python demo/module-05/05_threadpoolexecutor_basics.py
python demo/module-05/06_processpoolexecutor_cpu.py
python demo/module-05/07_concurrent_futures_comparison.py
python demo/module-05/08_timeouts_exception_handling.py
python demo/module-05/09_shared_state_locks.py
python demo/module-05/10_validation_service_concurrent.py
python demo/module-05/11_concurrency_antipatterns.py

# Verify all pass silently
for f in demo/module-05/*.py; do
  echo -n "=== $f: "
...
- Module 3 (SOLID) and Module 4 (Functional) patterns are referenced but not required
