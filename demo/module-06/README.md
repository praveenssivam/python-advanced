# Module 6 — Async Python with asyncio
...
python demo/module-06/02_asyncio_patterns.py
python demo/module-06/03_async_io_operations.py
python demo/module-06/04_async_concurrent_requests.py
python demo/module-06/05_asyncio_gather_patterns.py
python demo/module-06/06_async_context_managers.py
python demo/module-06/07_async_timeout_handling.py
python demo/module-06/08_async_semaphore_rate_limiting.py
...
- Module 5 (Concurrency) gives important context but is not strictly required

## Module 5 vs Module 6 — When to Use Each
