...
python demo/day-03/01_solid_single_responsibility.py
python demo/day-03/02_solid_open_closed.py
python demo/day-03/03_solid_liskov_substitution.py
python demo/day-03/04_solid_interface_segregation.py
python demo/day-03/05_solid_dependency_inversion.py
python demo/day-03/06_strategy_pattern.py
python demo/day-03/07_factory_pattern.py
python demo/day-03/08_observer_pattern.py
python demo/day-03/09_interface_design.py
python demo/day-03/10_extensible_design_combined.py
python demo/day-03/11_pattern_antipatterns.py
```
